...
@section('content')
            ...
            @forelse($managers as $user)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('payroll.manager.edit', $user->id) }}" class="btn btn-sm btn-dark">Edit Payroll</a>
    ...
    @if($deletedManagers->count())
            <h3 class="mt-5 text-danger">Deleted Managers</h3>
            <table class="table table-bordered table-striped mt-3">
                <thead>
                <tr>
                ...
                <tbody>
                @foreach($deletedManagers as $user)
                    <tr>

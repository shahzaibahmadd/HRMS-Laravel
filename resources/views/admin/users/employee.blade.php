...
@section('content')
    <div class="container mt-4">
            ...
            @forelse($employees as $user)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('payroll.admin.edit', $user->id) }}" class="btn btn-sm btn-dark">Edit Payroll</a>
        ...
        @if($deletedEmployees->count())
            <h3 class="mt-5 text-danger">Deleted Employees</h3>
            <table class="table table-bordered table-striped mt-3">
                <thead>
                <tr>
                ...
                <tbody>
                @foreach($deletedEmployees as $user)
                    <tr>
